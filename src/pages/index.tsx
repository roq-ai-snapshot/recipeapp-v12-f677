...
function HomePage() {
  return (
    <>
      <Head>
        <title>RecipeApp v12</title>

        <meta
          name="description"
          content="Empower Your Culinary Journey with RecipeApp v12: Explore, Review, and Master Diverse Recipes, Tailored to Your Taste and Skill Level - A Delicious World Awaits!"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Culinary Journey with RecipeApp v12: Explore, Review, and Master Diverse Recipes, Tailored to Your Taste and Skill Level - A Delicious World Awaits!`}
            </Text>
